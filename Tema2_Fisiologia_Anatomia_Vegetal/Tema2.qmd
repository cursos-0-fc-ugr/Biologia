...
El reino de las plantas, formado por organismos pluricelulares y autótrofos, no es un grupo estático, presenta una complejidad asombrosa que sostiene la vida en nuestro planeta. Al carecer de movilidad propia, las plantas han evolucionado mediante estrategias de adaptación únicas, optimizando la captura de energía solar y la gestión de recursos hídricos en entornos muy diversos. Este bloque te proporcionará una visión integral, desde el funcionamiento celular en la **fotosíntesis** hasta la sofisticada red de transporte de **savia** que recorre sus tejidos conductores. Analizaremos también cómo las **fitohormonas** actúan como \"mensajeros químicos\" para responder y adaptarse a estímulos ambientales y cómo sus complejos **ciclos reproductivos** garantizan la variabilidad genética y su supervivencia. Comprender estos mecanismos no es solo teoría biológica; es la base necesaria para abordar con éxito estudios sobre impacto ambiental o la gestión de ecosistemas naturales.
...
- **[Fase Fotoquímica :]{.underline}** Ocurre en los **tilacoides** del cloroplasto (los sacos aplanados dentro del cloroplasto). Es aquí donde se encuentran los pigmentos fotosintéticos (clorofilas, carotenoides) organizados en fotosistemas que absorben la luz.
   ...
   **Los 3 Hitos de la Fase Fotoquímica:**
   ...
   **En resumen:** La fase fotoquímica produce **ATP, NADPH y O₂**. Los dos primeros son la \"moneda energética\" y el \"poder reductor\" necesarios para la siguiente fase.
...
- **[Fase Bioquímica (Ciclo de Calvin):]{.underline}** Ocurre en el **estroma** (el espacio fluido que rodea a los tilacoides), se utiliza el ATP y el NADPH para fijar el CO2 y sintetizar azúcares gracias al ciclo de Calvin.
   ...
   **Los 3 Pasos del Ciclo de Calvin:**
     ...
     - **Reducción:** Se usan el ATP (energía) y el NADPH (electrones) de la fase fotoquímica para \"reducir\" el carbono y fabricar moléculas de G3P (un precursor de la glucosa).
